...
#else
  #define EVICT_LLC_SIZE        (256*MB) // increased for better evset construction
#endif
...
#define TEST_LEN  1000000  // 改为100万次，足够长时间采集
#define MAX_EVSET_CONST_RETRY 100
...
#define ENABLE_REDUCTION 0
  ...
  // DISABLED: Reduction fails on this system, accept larger eviction sets
